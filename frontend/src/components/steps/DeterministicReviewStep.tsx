...
function DataFrameGrid({ rows, label, badge, badgeColor = 'bg-blue-100 text-blue-700', height = 400 }: DataFrameGridProps) {
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <h4 className="text-sm font-semibold text-gray-900">
            Matched Records{' '}
            <span className="font-normal text-gray-400 text-xs">({det.matches.length} rows)</span>
          </h4>
    ...
    <div className="mt-5 space-y-4">
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          <div key={label} className="bg-gray-50 rounded-md p-4 text-center">
...
export default function DeterministicReviewStep({ sessionId, onSuccess }: Props) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      ...
      <h2 className="text-base font-semibold text-gray-900 mb-1">Confirm Deterministic Review</h2>
